	...
	return (
		<Row justify={'center'} align='middle' style={{ padding: '45px 0 ' }} className={Style.BioSection}>
			...
			<Col span={24} className={Style.Content}>
				<Row justify={'center'} align='middle' style={{ padding: '45px 0 ' }} className={Style.ContentInner}>
					<Col span={14}>
						...
						<p className={Style.BodyLarge}>
							...
							multi-platinum record producer from Miami, Florida who currently resides in Atlanta,
							Georgia.
						</p>
						...
						<p className={Style.BodySmall}>
							...
							fixture as a high-profile hip-hop producer, working with artists such as Lil Wayne, Eminem,
							Jay Z, Fat Joe, Fabolous, The Game, Meek Mill, 2 Chainz, Rick Ross, Big Sean, DJ Khaled and
							many others. STREETRUNNER is a 9x Grammy Nominated Producer and has won three awards for Rap
							Album of the year (Lil Wayne- Tha Carter III 2008), Rap Album of the year (Eminem- Marshall
							Mathers LP 2 2015), Best Rap Sung Performance (DJ Khaled “Higher” featuring Nipsey Hussle &
							John Legend 2019).
						</p>
						<Row>
							<Col md={9}>
